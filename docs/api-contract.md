...
Health está en `RM-10`. El resto de endpoints, en los slices que se indican. Swagger público: [`http://localhost:3001/docs`](http://localhost:3001/docs) (`RM-24`). Colección Postman: [`postman/checkout-api.postman_collection.json`](postman/checkout-api.postman_collection.json). Este markdown resume el mismo contrato.
